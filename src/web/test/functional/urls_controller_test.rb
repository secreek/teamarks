...
class UrlsControllerTest < ActionController::TestCase
  ...
  test "should create url" do
    assert_difference('Url.count') do
      post :create, url: { description: @url.description, page_title: @url.page_title, url: @url.url }
    end
  ...
  test "should update url" do
    put :update, id: @url, url: { description: @url.description, page_title: @url.page_title, url: @url.url }
    assert_redirected_to url_path(assigns(:url))
  end
